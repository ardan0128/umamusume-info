    ...
    <>
      <div>
        <svg viewBox="0 0 300 200">
          ...
          <text x="50" y="102" fontSize="110px" fontWeight="bold" fontFamily="Arial, Helvetica, sans-serif" style={{ fill: `#fefefe`, stroke: `#f44992`, strokeWidth: `5`, strokeLinejoin: `round` }}>
            마
          </text>
          <text x="150" y="102" fontSize="110px" fontWeight="bold" fontFamily="Arial, Helvetica, sans-serif" style={{ fill: `#fefefe`, stroke: `#f44992`, strokeWidth: `5`, strokeLinejoin: `round` }}>
            일
          </text>
          <polygon
