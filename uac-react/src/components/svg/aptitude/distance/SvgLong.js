    ...
    <>
      <div>
        <svg viewBox="0 0 208 56">
          ...
          <text x={20} y={45} fontSize="40px" fontFamily="Arial, Helvetica, sans-serif" style={{ fill: `#794017` }}>
            장거리
          </text>
          ...
          <text x={150} y={46} fontSize="50px" fontFamily="Arial, Helvetica, sans-serif" fontWeight="bold" fill="url(#textGradientE)" stroke="url(#borderGradientE)" strokeWidth={2}>
            E
          </text>
        </svg>
      </div>
