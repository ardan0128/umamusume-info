      ...
      <div>
        <div className="relative w-[300px] h-[200px]">
          ...
          <div className="absolute w-[120px] h-[120px] left-[140px] top-[5px]">
            <svg width="100%" height="100%" viewBox="0 0 120 120">
              <text x="7" y="96" fontSize="110px" fontWeight="bold" fontFamily="Arial, Helvetica, sans-serif" style={{ fill: `#fefefe`, stroke: `#189bdb`, strokeWidth: `5`, strokeLinejoin: `round` }}>
                워
              </text>
            </svg>
          </div>
...
export default SvgAptitudePower;
