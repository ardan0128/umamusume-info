function SvgAptitudeRunner() {
  return (
    <>
      <div>
        <svg viewBox="0 0 300 200">
          <polygon points="30,10 10,140 250,140 270,10" style={{ fill: `#ff83b8`, stroke: `#ff83b8`, strokeWidth: 5, strokeLinejoin: `round` }} />
          <text x="41" y="100" fontSize="110px" fontWeight="bold" fontFamily="Arial, Helvetica, sans-serif" style={{ fill: `#fefefe`, stroke: `#f44992`, strokeWidth: `5`, strokeLinejoin: `round` }}>
            도
          </text>
          <text x="152" y="100" fontSize="110px" fontWeight="bold" fontFamily="Arial, Helvetica, sans-serif" style={{ fill: `#fefefe`, stroke: `#f44992`, strokeWidth: `5`, strokeLinejoin: `round` }}>
            주
          </text>
          <polygon
...
export default SvgAptitudeRunner;
